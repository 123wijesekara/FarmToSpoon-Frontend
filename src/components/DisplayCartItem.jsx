...
import './DisplayCartItem.css' // Import styles
                    ...
                    {cartItem[0] ? (
                        <>
                            ...
                            <div className='cart-items'>
                                {cartItem.map((item, index) => (
                                    <div key={item?._id + "cartItemDisplay"} className='cart-item'>
                                        <div className='cart-item-img'>
                                            <img src={item?.productId?.image[0]} alt='item' />
                                        </div>
                            ...
                            <div className='bill-summary'>
                                ...
                                <div className='bill-row'>
                                    <p>Items total</p>
                                    <p><span className='line-through text-neutral-400'>{DisplayPriceInRupees(notDiscountTotalPrice)}</span> <span>{DisplayPriceInRupees(totalPrice)}</span></p>
                                </div>
                                <div className='bill-row'>
                                    <p>Quantity total</p>
                                    <p>{totalQty} item</p>
                        ...
                        <div className='cart-empty'>
                            ...
                            <Link onClick={close} to={"/"}>Shop Now</Link>
                        </div>
                    )}
                </div>
