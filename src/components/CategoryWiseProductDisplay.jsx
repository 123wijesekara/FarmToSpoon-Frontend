...
// const CategoryWiseProductDisplay = ({ id, name, sortBy, sortOrder }) => {
//     const [data, setData] = useState([]);
//     const [loading, setLoading] = useState(false);
//     const containerRef = useRef();
//     const subCategoryData = useSelector(state => state.product.allSubCategory);
...
const CategoryWiseProductDisplay = ({ id, name, sortBy = 'createdAt', sortOrder = 'desc', district = '',searchTerm = '' }) => {
    ...
    return (
        <div>
            <div className='container mx-auto p-4 flex items-center justify-between gap-4'>
                <h3 className='font-semibold text-lg md:text-xl'>{name}</h3>
                <Link to={getRedirectURL()} className='text-green-600 hover:text-green-400'>
                    See All
                </Link>
            </div>
            <div className='relative flex items-center'>
                ...
                <div className='w-full container mx-auto px-2 absolute hidden lg:flex justify-between'>
                    <button
