...
import image2 from '../assets/fairprice.jpeg'
import image1 from '../assets/fresh.jpeg'
import image3 from '../assets/quick.jpeg'
  ...
  const fetchProductDetails = async () => {
    try {
      ...
      if (responseData.success) {
        ...
        alert(responseData.message || "Product not found");
      }
    } catch (error) {
